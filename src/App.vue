...
import NodeConfigPanel from '@/components/inspector/NodeConfigPanel.vue'
...
<style scoped>
.app-root { width: 100%; height: 100%; display: flex; flex-direction: column; background: var(--canvas-bg); color: var(--panel-text); }
.app-body { flex: 1; display: flex; overflow: hidden; position: relative; min-height: 0; }
.canvas-area { flex: 1; display: flex; flex-direction: column; min-width: 0; overflow: hidden; position: relative; }
</style>

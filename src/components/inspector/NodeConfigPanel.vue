    ...
    <div class="panel-body">
      ...
      <template v-if="nodeData.type === 'trigger'">
        <label class="field">
          ...
          <select
            class="field-input"
            :value="(nodeData as TriggerNodeData).mode"
        ...
        <label v-if="(nodeData as TriggerNodeData).mode === 'schedule'" class="field">
          ...
          <input
            class="field-input"
            type="time"
            :value="(nodeData as TriggerNodeData).scheduleTime"
        ...
        <template v-if="(nodeData as TriggerNodeData).mode === 'interval'">
          <label class="field">
            ...
            <input
              ...
              type="number"
              min="1"
              :value="(nodeData as TriggerNodeData).intervalValue"
          ...
          <label class="field">
            ...
            <select
              class="field-input"
              :value="(nodeData as TriggerNodeData).intervalUnit"
      ...
      <template v-if="nodeData.type === 'delay'">
        <label class="field">
          ...
          <input
            ...
            type="number"
            min="1"
            :value="(nodeData as DelayNodeData).value"
        ...
        <label class="field">
          ...
          <select
            class="field-input"
            :value="(nodeData as DelayNodeData).unit"
      ...
      <template v-if="nodeData.type === 'webhookMessage'">
        <label class="field">
          ...
          <input
            ...
            type="url"
            placeholder="https://..."
            :value="(nodeData as WebhookMessageNodeData).webhookUrl"
        ...
        <label class="field">
          ...
          <textarea
            ...
            rows="3"
            :value="(nodeData as WebhookMessageNodeData).messageText"
      ...
      <!-- Delete -->
      <button class="delete-btn" @click="store.removeNode(node.id)">
        Delete Node
      </button>
    </div>
  </aside>
